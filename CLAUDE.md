...
*Esse arquivo é o kernel do CortexOS. Trate-o como código de produção: cada regra aqui é uma decisão tomada. Para mudar uma regra, pergunte antes de editar.*
